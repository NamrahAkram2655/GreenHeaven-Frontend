...
//       <div className="relative bg-white shadow-md p-5 flex items-center justify-between">
//         {/* Filters on the left */}
...
//         <form className="flex items-center border border-[#438A4B] rounded-md px-3 py-1">
//           <input
//             type="text"
//             placeholder="Search..."
//             className="outline-none bg-transparent text-gray-700 px-2"
//             value={searchQuery}
